        ...
        <form action="#" className="space-y-8 border-2 p-10 rounded-xl">
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
            <div>
              ...
              <input type="text" id="fname" className="shadow-sm bg-gray-50 border border-gray-300 placeholder-gray-50 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-700 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Firstname" required />
            </div>
            <div>
